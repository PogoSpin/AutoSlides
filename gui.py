...
topic.grid(pady = 15, padx = xSize/8.333, sticky = 'ew')

topic = ctk.CTkEntry(window, placeholder_text = 'Amount of Slides')
topic.grid(pady = 0, padx = xSize/8.333, sticky = 'ew')

button = ctk.CTkButton(window, text = 'Generate Slides')
button.grid(pady = 40, padx = xSize/8.333, sticky = 'ew')
